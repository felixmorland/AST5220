...
lna, Xe, ne, tau, dtaudx, ddtauddx, g_tilde, dgdx, ddgddx, sound_hor, Xe_saha = np.loadtxt('../results/recombination/recombination_He_reion.txt', unpack=True)
decoupling = -6.97282

# Recombination data: H + He, NO reionisation
lna_He_noreion, Xe_He_noreion, ne_He_noreion, tau_He_noreion, dtaudx_He_noreion, ddtauddx_He_noreion, g_tilde_He_noreion, dgdx_He_noreion, ddgddx_He_noreion, sound_hor_He_noreion, Xe_saha_He_noreion = np.loadtxt('../results/recombination/recombination_He_noreion.txt', unpack=True)

# Recombination data: H, NO reionisation
lna_H_noreion, Xe_H_noreion, ne_H_noreion, tau_H_noreion, dtaudx_H_noreion, ddtauddx_H_noreion, g_tilde_H_noreion, dgdx_H_noreion, ddgddx_H_noreion, sound_hor_H_noreion, Xe_saha_H_noreion = np.loadtxt('../results/recombination/recombination_H_noreion.txt', unpack=True)

# Recombination data: H, reionisation
lna_H_reion, Xe_H_reion, ne_H_reion, tau_H_reion, dtaudx_H_reion, ddtauddx_H_reion, g_tilde_H_reion, dgdx_H_reion, ddgddx_H_reion, sound_hor_H_reion, Xe_saha_H_reion = np.loadtxt('../results/recombination/recombination_H_reion.txt', unpack=True)
...
axs[0,0].plot(lna_H_noreion, -dtaudx_H_noreion, color=col['blue'], linestyle='-')
axs[0,0].plot(lna_H_noreion, ddtauddx_H_noreion, color=col['red'], linestyle='-')
...
axs[0,1].plot(lna_H_reion, -dtaudx_H_reion, color=col['blue'], linestyle='-')
axs[0,1].plot(lna_H_reion, ddtauddx_H_reion, color=col['red'], linestyle='-')
...
axs[1,0].plot(lna_He_noreion, -dtaudx_He_noreion, color=col['blue'], linestyle='-')
axs[1,0].plot(lna_He_noreion, ddtauddx_He_noreion, color=col['red'], linestyle='-')
...
axs[1,1].plot(lna, -dtaudx, label=r"$-\tau'(x)$", color=col['blue'], linestyle='-')
axs[1,1].plot(lna, ddtauddx, label=r"$\tau''(x)$", color=col['red'], linestyle='-')
...
fig.legend(loc='upper center',  ncols=3, fontsize=16)
fig.subplots_adjust(hspace=0.0, wspace=0.0, top=0.92)
...
axs[1].axvline(-7.14035, color=col['blue'], label=r'Saha $x_\mathrm{rec}=-7.14$')
axs[1].axvline(-6.97013, color=col['red'], label=r'Peebles $x_\mathrm{rec} = -6.97$')
...
ax1.axvline(decoupling, color=col['blue'], label=r'$x_\mathrm{dec}=$'+f' {decoupling:.3f}')
