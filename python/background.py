...
# Observational data
chi2, h, OmegaM, OmegaK = np.loadtxt('../results/background/results_supernovafitting.txt', skiprows=1000, unpack=True)
OmegaLambda = 1 - OmegaM - OmegaK

# Data from best fit run
bflna, bfeta, bfHp, bfdHpdx, bfddHpddx, bfOmegaB, bfOmegaCDM, bfOmegaL, bfOmegaR, bfOmegaNu, bfOmegaK, bflumdist, bfangdist, bft = np.loadtxt('../results/background/best_fit_cosmology.txt', unpack=True) 
...
lna, eta, Hp, dHpdx, ddHpddx, OmegaB, OmegaCDM, OmegaL, OmegaR, OmegaNu, OmegaK, lumdist, angdist, t = np.loadtxt('../results/background/fiducial_cosmology.txt', unpack=True) 
