...
filenames = {
    ...
    'Master level PS'       : 'power_spectrum_data/cells_master.txt',
...
k_array, matter_ps = np.loadtxt('power_spectrum_data/matter_ps.txt', unpack=True, skiprows=1) 
with open('power_spectrum_data/matter_ps.txt', 'r') as infile:
